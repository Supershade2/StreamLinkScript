...
streamlink --player-http twitch.tv/$name $quality -o /home/$username/Videos/$name$current_date_time.mp4
else
...
echo "What quality do you want?"
read quality
streamlink --player-http twitch.tv/$selectedchannel $quality -o /home/$username/Videos/$name$current_date_time.mp4
fi
